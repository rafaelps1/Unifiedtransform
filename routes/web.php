...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::prefix('register')->name('register.')->group(function () {
        ...
        Route::get('teacher', function () {
            $departments = \App\Department::where('school_id', \Auth::user()->school_id)->orderBy('department_name', 'asc')->get();
            $classes = \App\Myclass::where('school_id', \Auth::user()->school->id)->orderBy('class_number', 'asc')->pluck('id');
